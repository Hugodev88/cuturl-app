        ...
        <ul className="dashboard-list">
          {urls.map((url) => (
            <li key={url._id}>
              ...
              <p><strong>Short URL:</strong> <a href={`http://localhost:3000/api/url/${url.shortUrl}`} target="_blank" rel="noopener noreferrer">{`http://localhost:3000/api/url/${url.shortUrl}`}</a></p>
